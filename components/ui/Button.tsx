...
export function Button({
  ...
  const styles = cn(
    "button-link inline-flex min-h-11 items-center justify-center gap-2 border px-4 py-2.5 font-mono text-xs font-bold uppercase tracking-[0.12em] transition duration-150",
